sap.ui.controller("queryregistry.Section.SapRole", {
...
//	},
	...
	var oControl = new sap.ui.commons.TextView({text:"{RoleId}"}); // short binding notation
	oTable.addColumn(new sap.ui.table.Column({
		label: new sap.ui.commons.Label({text: "Роль"}), 
		template: oControl }));
	
	oControl = new sap.ui.commons.TextView({text:"{RoleText}"}); // more verbose binding notationt
	oTable.addColumn(new sap.ui.table.Column({
