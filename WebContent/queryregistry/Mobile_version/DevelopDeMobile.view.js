  sap.ui.jsview("queryregistry.Mobile_version.DevelopDeMobile",
		{
			 ...
			 */
			 getControllerName : function() {
				return "queryregistry.Mobile_version.DevelopDeMobile";
			},
			...
			createContent : function(oController) {
				...
				var self = this;
				var oTable = oController.createTable("idNew", oController,
						self, 'new');
