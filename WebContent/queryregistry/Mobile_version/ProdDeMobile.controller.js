  sap.ui.controller("queryregistry.Mobile_version.ProdDeMobile", {
...
//						}));
		...
		var oFilterInTest = new sap.ui.model.Filter("StatusCode", sap.ui.model.FilterOperator.EQ, '08');
		var oFilterTestApprove = new sap.ui.model.Filter("StatusCode", sap.ui.model.FilterOperator.EQ, '09');
		var oFilterTest = new sap.ui.model.Filter("StatusCode", sap.ui.model.FilterOperator.EQ, '10');
		...
		function pushApprove(){
			...
			var oModelApproveProd = new sap.ui.model.odata.v2.ODataModel(link, {
		    ...
		    oModelApproveProd.update("/Query_registrySet('" + oEntry.Trkorr + "')", oEntry );
			...
			function openDeleteDialog(Trkorr){
				...
				oDeleteDialog.addButton(
					new sap.ui.commons.Button({
						text: "Да", 
						press:function(){ 
							sap.ui.getCore().getModel().remove("/Query_registrySet('" + title1 + "')", {
								success: function(){
								var oModel = new sap.ui.model.odata.v2.ODataModel(link, {
							    	 useBatch: false,
							    	 defaultUpdateMethod: "Put"
