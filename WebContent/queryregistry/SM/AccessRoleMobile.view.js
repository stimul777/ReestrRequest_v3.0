  sap.ui.jsview("queryregistry.SM.AccessRoleMobile", {
	...
	*/ 
	getControllerName : function() {
		return "queryregistry.SM.AccessRoleMobile";
	},
		...
		var tabBar = new sap.m.IconTabBar({
			...
			items : [
					new sap.m.IconTabFilter({
						text: "Роли",
						content : oController.createTable("idAccessRoleDe",
								oController, this)
					})]
		});
		var MenuButton = new sap.m.Button({
			...
			press : function() {
				...
				var oSplitApp = sap.ui.getCore().byId(
						'workDeskSplitApp');
				oSplitApp.backToPage("security");

			}

		});
		var Title = new sap.m.Label({text: "Роли доступа SAP"});
